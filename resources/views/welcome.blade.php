                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                ...
                                <br><br><a href="{{ asset('./storage/ebk/MANUALPENGGUNA.pdf') }}" class="btn btn-sm fa fa-info" style="background-color:Navy; color:white">MANUAL PANDUAN PENGGUNA</button></a></div>
