...
<div class="container">
        ...
        <table style="border-collapse: collapse; width: 99.1206%; height: 71px;" border="1">
            ...
            <tr>
                <td style="width: 25%;" colspan="4">&nbsp;<textarea class="form-control" name="bidang_tugas1" value="" readonly>{{$data['bidang_tugas']}}</textarea></td>
            </tr>
            ...
            <tr style="height: 18px;">
                ...
                <td style="width: 20%; height: 18px; text-align: center;"><input class="form-control" name="sasaran1" type="text" value="{{$data['sasaran']}}" readonly /></td>
